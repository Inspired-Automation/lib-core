...
1. **Team config (required):** `I:\BPI\Automation Team\Tools\Scripts\yaml\team.yaml`. Contains Graph credentials, Freshservice credentials, default notification recipient, and the production root path.
